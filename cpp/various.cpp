...
int main(){
    ...
    char ch_f = str6.front(); // Same as "ch)f = str6[0];"
    ...
    // find returns index where pattern is found. If pattern is not there it returns
    // the predefined constant npos whose value is -1
    ...
    // subtstr(a, b) function returns a substring of b length
    ...
    // replace(a, b, str) replaces b character from a index with str
